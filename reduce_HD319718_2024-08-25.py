...
def main():
    ...
    thisred.makePaths(redux_path="/Users/rcooke/Work/Research/BBN/helium34/Absorption/2023_CRIRES_Survey/HD319718/2024-08-25/")
...
class Reduce(ReduceBase):
    ...
    def get_science_frames(self):
        return [
            # Raw/CRIRE.2024-08-25T01:56:47.259.fits 1 A 1.0 240.0 HD 319718 2.15
            # Raw/CRIRE.2024-08-25T02:01:08.200.fits 1 B 1.0 240.0 HD 319718 2.15
            # Raw/CRIRE.2024-08-25T02:05:37.356.fits 1 A 6.5 240.0 HD 319718 2.15
            # Raw/CRIRE.2024-08-25T02:10:02.394.fits 1 B 6.5 240.0 HD 319718 2.15
            #                A=1.0  (spec=12  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T01:56:47.259.fits"], ["CRIRE.2024-08-25T02:10:02.394.fits"]],  # B=6.5
            #                B=1.0  (spec=13  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:01:08.200.fits"], ["CRIRE.2024-08-25T02:05:37.356.fits"]],  # A=6.5
            #                A=6.5  (spec=14  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:05:37.356.fits"], ["CRIRE.2024-08-25T02:01:08.200.fits"]],  # B=1.0
            #                B=6.5  (spec=15  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:10:02.394.fits"], ["CRIRE.2024-08-25T01:56:47.259.fits"]],  # A=1.0
            # Raw/CRIRE.2024-08-25T02:14:37.442.fits 1 A 2.0 240.0 HD 319718 2.15
            # Raw/CRIRE.2024-08-25T02:18:55.606.fits 1 B 2.0 240.0 HD 319718 2.15
            # Raw/CRIRE.2024-08-25T02:23:23.832.fits 1 A 5.5 240.0 HD 319718 2.15
            # Raw/CRIRE.2024-08-25T02:27:49.488.fits 1 B 5.5 240.0 HD 319718 2.15
            #                A=2.0  (spec=16  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:14:37.442.fits"], ["CRIRE.2024-08-25T02:27:49.488.fits"]],  # B=5.5
            #                B=2.0  (spec=17  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:18:55.606.fits"], ["CRIRE.2024-08-25T02:23:23.832.fits"]],  # A=5.5
            #                A=5.5  (spec=18  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:23:23.832.fits"], ["CRIRE.2024-08-25T02:18:55.606.fits"]],  # B=2.0
            #                B=5.5  (spec=19  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:27:49.488.fits"], ["CRIRE.2024-08-25T02:14:37.442.fits"]],  # A=2.0
            # Raw/CRIRE.2024-08-25T02:32:23.788.fits 1 A 2.5 240.0 HD 319718 2.15
            # Raw/CRIRE.2024-08-25T02:36:50.011.fits 1 B 2.5 240.0 HD 319718 2.15
            # Raw/CRIRE.2024-08-25T02:41:19.726.fits 1 A 5.0 240.0 HD 319718 2.15
            # Raw/CRIRE.2024-08-25T02:45:52.311.fits 1 B 5.0 240.0 HD 319718 2.15
            #                A=2.5  (spec=20  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:32:23.788.fits"], ["CRIRE.2024-08-25T02:45:52.311.fits"]],  # B=5.0
            #                B=2.5  (spec=21  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:36:50.011.fits"], ["CRIRE.2024-08-25T02:41:19.726.fits"]],  # A=5.0
            #                A=5.0  (spec=22  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:41:19.726.fits"], ["CRIRE.2024-08-25T02:36:50.011.fits"]],  # B=2.5
            #                B=5.0  (spec=23  DIT=180.0  NDIT=1)
            [["CRIRE.2024-08-25T02:45:52.311.fits"], ["CRIRE.2024-08-25T02:32:23.788.fits"]]]  # A=2.5
    ...
    def get_dark_frames(self):
        ...
        return [["CRIRE.2024-08-21T05:27:37.468.fits", "CRIRE.2024-08-21T05:28:00.820.fits", "CRIRE.2024-08-21T05:28:24.165.fits"],#5s
                ["CRIRE.2024-08-24T15:28:41.101.fits", "CRIRE.2024-08-24T15:30:46.608.fits", "CRIRE.2024-08-24T15:32:52.128.fits"]]#120s

    def get_arc_frames(self):
        return ["CRIRE.2024-08-24T15:20:08.623.fits"]
